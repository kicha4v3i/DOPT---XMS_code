...
$(window).on("load", function () {
  ...
  var gainedChart2 = new ApexCharts(
    document.querySelector("#subscribe-gain-chart2"),
    gainedChartoptions
  );

  gainedChart2.render();
  var gainedChart3 = new ApexCharts(
    document.querySelector("#subscribe-gain-chart3"),
    gainedChartoptions
  );
  ...
  // tour steps
  tour.addStep('step-1', {
    text: 'Dashboard comes here',
    attachTo: '.dashboardmenu right',
    buttons: [
  ...
  tour.addStep('step-2', {
    text: 'Create your Projects Here. You can also view your projects here.',
    attachTo: '.projectsmenu right',
    buttons: [
  ...
  tour.addStep('step-3', {
    text: 'Create your Vendors Here. You can also view your vendors here.',
    attachTo: '.vendorsmenu right',
    buttons: [
  ...
  tour.addStep('step-4', {
    text: 'Create your Master Templates Here. You can also view your Master Templates here.',
    attachTo: '.templatesmenu right',
    buttons: [
  ...
  tour.addStep('step-5', {
    text: 'Create users for the applications here.',
    attachTo: '.usersmenu right',
    buttons: [
  ...
  tour.addStep('step-6', {
    text: 'In app settings are shown here',
    attachTo: '.settingsmenu right',
    buttons: [
  ...
  tour.addStep('step-7', {
    text: 'You can Search Things here',
  ...
  tour.addStep('step-8', {
    text: 'Important Notifications are shown here',
    attachTo: '.dropdown-notification bottom',
    buttons: [
  ...
  if ($(window).width() > 1200 && !$("body").hasClass("superadmin")) {
